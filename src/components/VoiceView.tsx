    ...
    <div className="flex-1 flex flex-col bg-[#1e1f22] h-full">
        ...
        <div className="flex-1 flex flex-col">
          {stream && (
            <div className="flex-1 relative bg-black flex items-center justify-center">
              ...
              />
              <div className="absolute top-4 left-4 bg-[#1e1f22]/90 px-3 py-1.5 rounded-lg flex items-center">
                <div className="w-2 h-2 rounded-full bg-[#ed4245] mr-2 animate-pulse"></div>
                <span className="text-sm text-white font-medium">Трансляция экрана</span>
              </div>
              <button
          ...
          {!stream && (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-[#949ba4] mb-4">Вы подключены к каналу "{channel.name}"</p>
                <button
      ...
      <div className="h-16 bg-[#232428] border-t border-[#1f2023] flex items-center justify-center gap-3 px-4">
        ...
        <button
          ...
          className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
            stream ? 'bg-[#5865f2] text-white' : 'bg-[#313338] text-[#b5bac1] hover:bg-[#3b3d44]'
          }`}
          title={stream ? 'Остановить трансляцию' : 'Начать трансляцию'}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 12l-6-3.5 6-3.5v7z"/>
          </svg>
